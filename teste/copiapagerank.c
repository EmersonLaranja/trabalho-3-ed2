...
int comparePages(const void *a, const void *b)
{
    if ((*(struct PageRank *)a).value == (*(struct PageRank *)b).value)
    {
        ...
        {
            printf("%d %.18lf ==  %d %.18lf    ", (*(struct PageRank *)a).pageId, (*(struct PageRank *)a).value, (*(struct PageRank *)b).pageId, (*(struct PageRank *)b).value);
            printf("%d > %d\n", (*(struct PageRank *)a).pageId, (*(struct PageRank *)b).pageId);
            return -1;
        }
        else
        {
    ...
    if ((*(struct PageRank *)a).value < (*(struct PageRank *)b).value)
    {
        printf("%d %.18lf  <  %d %.18lf \n", (*(struct PageRank *)a).pageId, (*(struct PageRank *)a).value, (*(struct PageRank *)b).pageId, (*(struct PageRank *)b).value);
        return -1;
    }
    else
    {
